...
tagged_abstracts1,untagged_abstracts1,tags1,excluded1 = clf.apply_features(data_raw1,clf.feature_extractor)
...
tagged_abstracts2,untagged_abstracts2,tags2,excluded2 = clf.apply_features(data_raw2,clf.feature_extractor)
...
tagged_abstracts3,untagged_abstracts3,tags3,excluded3 = clf.apply_features(data_raw3,clf.feature_extractor)
...
tagged_abstracts4,untagged_abstracts4,tags4,excluded4 = clf.apply_features(data_raw4,clf.feature_extractor)
